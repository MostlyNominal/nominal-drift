...
- crystal dataset pipelines
- reporting and narration tools
- mechanism animation engines

The objective is simple:

> Ask scientific questions in natural language  
> and receive physically grounded outputs.
...
- sensitization and depletion studies
- heat-treatment mechanism studies
- local LLM scientific narration
- static engineering plots
- microstructure-style mechanism animations
...
- `Perov-5`
- `Carbon-24`
- CIF-based public crystal repositories
- `pymatgen`-driven structure parsing
- normalization + indexing pipelines
- future `DiffCSP`-style structure workflows
- `matbench-genmetrics` evaluation bridge
...
> crystal-aware diffusion  
> structure-guided materials discovery  
> DFT-ready local workflows
...
- grain evolution studies
- diffusion pathway visualisation
- crystal structure workflows
- future DFT and CSP integration

The long-term vision is a system where you can ask:

> Why did this alloy fail after this heat treatment?

> How deep is chromium depletion after 700°C for 1 hour?

> Can this crystal structure support fast diffusion pathways?

and receive physically grounded, inspectable answers.
...
- dataset ingestion
- `pymatgen` structure workflows
- GUI stabilization
- DiffCSP / crystal data alignment
...
It is about building a system that helps us:

- think faster
- test earlier
- validate mechanisms sooner
- preserve experimental reasoning
- learn from wrong assumptions

A scientific workspace.  
A lab notebook.  
A reasoning engine.

Mostly nominal.

Until it drifts into discovery.