"""
Downloader for the MP-20 dataset (CDVAE).
...
class MP20Downloader(BaseDownloader):
    """Download MP-20 dataset from CDVAE repo."""

    dataset_name = "mp-20"
    source_url = "https://raw.githubusercontent.com/txie-93/cdvae/main/data/mp_20/"
    expected_files = ["train.csv", "val.csv", "test.csv"]

    def download(self, force: bool = False) -> DownloadResult:
        """Download MP-20 dataset."""
        ...
        if not files_downloaded:
            ...
            info_path.write_text(
                f"MP-20 dataset download failed.\n"
