"""
Downloader for the PEROV-5 dataset (CDVAE).
...
class Perov5Downloader(BaseDownloader):
    """Download PEROV-5 dataset from CDVAE repo."""

    dataset_name = "perov-5"
    source_url = "https://raw.githubusercontent.com/txie-93/cdvae/main/data/perov_5/"
    expected_files = ["train.csv", "val.csv", "test.csv"]

    def download(self, force: bool = False) -> DownloadResult:
        """Download PEROV-5 dataset."""
        ...
        if not files_downloaded:
            ...
            info_path.write_text(
                f"PEROV-5 dataset download failed.\n"
