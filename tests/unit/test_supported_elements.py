...
class TestGetSupportedForMatrix:
    ...
    def test_unknown_matrix_returns_full_set(self):
        """Fallback for unknown matrix is the full supported set."""
        result = get_supported_for_matrix("totally_unknown_matrix")
        assert result == DIFFUSION_SUPPORTED

    def test_empty_matrix_string_returns_full_set(self):
